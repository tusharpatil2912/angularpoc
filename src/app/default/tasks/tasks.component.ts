...
export class TasksComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { headerName:'Task Name',field: 'taskName', width: 200,minWidth: 100, resizable: true, sortable: true,  filter: true},
    { headerName:'Task Status',field: 'taskStatus',valueFormatter: this.stringFormatter, width: 250,minWidth: 100, resizable: true, sortable: true, filter: true },
...
getAllTasksByResourceId(){
  ...
  this.detailsapi.getTaskByResourceId(currentUser['user'].resourceId).subscribe((data)=>{
    //console.log(data);
    this.taskList = data;
    this.rowData = data;
  },(error)=>{
